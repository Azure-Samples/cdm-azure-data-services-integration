...
IF(OBJECT_ID('dbo.uspTransformWideWorldImporters-Orders')) IS NOT NULL DROP PROCEDURE [dbo].[uspTransformWideWorldImporters-Orders]
GO

-- WideWorldImporters-Orders model transform controller
CREATE PROCEDURE [dbo].[uspTransformWideWorldImporters-Orders]
AS
BEGIN
...
EXEC [dbo].[uspTransformWideWorldImporters-Orders]

Query dimensional model tables mapped from entity model WideWorldImporters-Orders
